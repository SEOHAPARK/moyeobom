    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100">
        <div className="max-w-xl mx-auto px-4 py-3 text-center">
          <h1 className="text-base font-bold text-gray-900">행사 종료 안내</h1>
        </div>
      </header>

      <main className="max-w-xl mx-auto px-4 py-12 flex flex-col items-center text-center gap-3">
        <div className="w-14 h-14 rounded-full border-2 border-gray-300 flex items-center justify-center text-2xl text-gray-400">
          🚫
        </div>
        <h2 className="text-lg font-bold text-gray-900">행사 종료</h2>
