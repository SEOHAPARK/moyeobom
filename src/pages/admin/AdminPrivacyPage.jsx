  ...
  return (
    <div className="flex flex-col gap-5 max-w-3xl">
      ...
      <div className="flex justify-end gap-2">
        ...
        <button onClick={() => navigate('/admin')} className="bg-brand-600 text-white hover:bg-brand-700 transition-colors cursor-pointer rounded-lg px-4 py-2 text-sm font-semibold">
          확인 및 닫기
        </button>
      </div>
    </div>
